...
/**
 * Created by Ksyusha on 20.02.2015.
 */
...
import app.test.sunshine.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    public FetchWeatherTask(Context context, ArrayAdapter<String> forecastAdapter) {
        mycontext = context;
        myforecastAdapter = forecastAdapter;
    }
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mycontext.getString(R.string.pref_units_key),
                mycontext.getString(R.string.pref_units_metric));

        if (unitType.equals(mycontext.getString(R.string.pref_units_imperial))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mycontext.getString(R.string.pref_units_metric))) {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor locationCursor = mycontext.getContentResolver().query(
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                mycontext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, cvArray);
            }
            ...
            Cursor cur = mycontext.getContentResolver().query(weatherForLocationUri,
    ...
    protected void onPostExecute(String[] result) {
        if (result != null && myforecastAdapter != null) {
